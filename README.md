...
### SimpleGraph: Methods and fields.
...
#################################################################
# SimpleGraph - <pl: graf prosty> - no multiple edges are allowed
...
##############################
# Multigraph - <pl: multigraf> - it is different from SimpleGraph in only one way: when connecting two new nodes, it does not check if they are allready connected.
mgraph = Multigraph()
mgraph.add_nodes(2)
...
# You do not create a node in this way!!!!
n = Node()
# DO NOT DO THIS.
